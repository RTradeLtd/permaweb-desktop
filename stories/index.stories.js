...
const exampleFiles = [
  {
    ...
    latestEventDescription:
      'Ashkay: I recommend this tutorial! Cheeck out this link https://example.com'
  },
  {
    id: '2',
...
storiesOf('Navigation', module).add('inside category', () => (
...
storiesOf('Components/Sidebar', module).add('multiple categories', () => (
  <ThemeProvider theme={theme}>
    <Sidebar
      avatarImage={shokuninAvatarImage}
      categories={exampleCategories}
...
storiesOf('Components/FolderListing', module).add('small list of files', () => (
  <ThemeProvider theme={theme}>
    <FolderListing>
